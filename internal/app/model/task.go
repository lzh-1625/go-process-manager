...
type Task struct {
	...
	Condition       types.Condition       `gorm:"column:condition;NOT NULL" json:"condition" `
	NextID          *int                  `gorm:"column:next_id;" json:"nextId" `
	Operation       types.TaskOperation   `gorm:"column:operation;NOT NULL" json:"operation" `
	TriggerEvent    *process.ProcessState `gorm:"column:trigger_event;" json:"triggerEvent" `
