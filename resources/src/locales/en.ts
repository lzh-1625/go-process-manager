export default {
  ...
  processCardPage: {
    ...
    controlDescription: "Take control of this process, disconnect the user currently connected to the terminal, and prevent other users from writing to the terminal during this period.",
