export default {
  ...
  processCardPage: {
    ...
    memoryLimit: "内存限制（MB）",
    control: "获取控制权",
    controlDuration: "控制时长（秒）",
    controlDurationHint: "范围：1–3600 秒",
    controlDurationRule: "请输入 1–3600 之间的整数秒数",
    controlDescription: "获取该进程的控制权，踢掉当前连接终端的用户，设置时间内禁止其他用户访问终端进行写入",
    delete: "删除进程",
    ...
    deleteSuccess: "删除成功",
    deleteUnavailable: "请先停止进程后再删除",
    confirmDelete: "确认删除",
    deleteConfirmMessage: "确定要删除进程 {name} 吗？此操作无法撤销。",
